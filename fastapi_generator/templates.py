...
class TemplateManager:
    ...
    def get_template_files(self, template_type: str) -> List[Dict[str, str]]:
        ...
        templates = {
            ...
            "full": [
                # Tous les fichiers du template minimal plus:
                {"template": "main_full.py.j2", "output": "main.py"},
    ...
    def render_file(self, template_name: str, output_path: Path, context: Dict[str, Any]) -> None:
    ...
    def render_router(self, project_path: Path, router_name: str, 
                     model_name: str = None, include_crud: bool = False) -> None:
        """Rendre un template de router"""
        
        context = {
            "router_name": router_name,
            "model_name": model_name or router_name.title(),
    ...
    def render_model(self, project_path: Path, model_name: str, fields: Dict[str, str]) -> None:
